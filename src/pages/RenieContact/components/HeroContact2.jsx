      ...
      <div className="md:flex justify-between">
        ...
        <section className=" md-w-[85%] hidden md:flex ">
          ...
          <div className="p-4 w-[60%] shadow-md md:flex">
            ...
            <div className="mt-4">
               <h2 className="text-[14px] leading-[27px] font-[600] text-gray-500">Time Zone</h2>
               <span>Dubai Time (03:00)</span> <br />
               <p className="border border-gray-600 py-2 rounded-3xl mt-5 w-[150px] text-center">Troubleshoot</p>
            </div>
            </section>
            ...
            <sections className= "flex flex-col gap-4">
              ...
              <div className=" translate-y-8">
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">09:00</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">09:30</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">10:00</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">10:30</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">11:00</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">11:30</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">12:00</p>
                <p className=" border-[1px] border-blue-400 text-center rounded-sm px-[2rem] py-[.80rem] my-[1rem]">12:30</p>
              </div>
            </sections>
          </div>
        </section>
