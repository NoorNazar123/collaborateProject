    ...
    <div>
      ...
      >
        <div className="w-[660px]">
          ...
          The connection interface changes according to the user’s preferences.
          </h3>
          <span className="text-[18px] leading-[27px] font-[300]">Our AI powered advertisement platform provides you with the complete interface that displays relevant ads based on the preference of the app user.</span> <br/>
